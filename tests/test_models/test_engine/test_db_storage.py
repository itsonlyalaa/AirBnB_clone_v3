...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertIs(None, models.storage.get("State", "wtvr"))
        self.assertIs(None, models.storage.get("wtvr", "wtvr"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("Wtvr"), 0)
        newState = State(name="Youtubechannel")
        newState.save()
        newUser = User(email="alaaokair330@gmail.com.com", password="easyyouidiot")
        newUser.save()
